...
from launch.actions import DeclareLaunchArgument, RegisterEventHandler, ExecuteProcess, LogInfo
...
def generate_launch_description():
    ...
    world_file_path = PathJoinSubstitution([FindPackageShare('gazebo_ros'), 'worlds', 'empty.world'])
    ...
    spawn_entity_node = Node(
        ...
        arguments=['-topic', 'robot_description', '-entity', 'shelfbot', '-Y', '0', '-x', '0', '-y', '0', '-z', '0.1', '-unpause'],
        output='screen'
    )
    ...
    return LaunchDescription(declared_arguments + debug_statements + nodes)
